  ...
  <div class="skill-set">
    <div class="skill-header">
      ...
      <div class="skill-filters">
        ...
        <a :class="{ 'is-active': filter === 'api' }" @click="filter = 'api'">API</a>
        <a :class="{ 'is-active': filter === 'mobile' }" @click="filter = 'mobile'">Mobile</a>
        <a :class="{ 'is-active': filter === 'test' }" @click="filter = 'test'">Testing</a>
        <a :class="{ 'is-active': filter === 'visual' }" @click="filter = 'visual'">Data Visualization</a>
